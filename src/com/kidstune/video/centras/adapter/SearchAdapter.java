...
public class SearchAdapter extends BaseAdapter{
	...
	public SearchAdapter(Context context, ArrayList<Main_Data> list, ListView listview_main) {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		try{
			...
			cursor = Search_Activity.favorite_mydb.getReadableDatabase().rawQuery(
			...
			bt_favorite.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(num.equals("empty")){
						...
						Search_Activity.favorite_mydb.getWritableDatabase().insert("favorite_list", null, cv);
						...
						bt_favorite.setImageResource(R.drawable.bt_favorite_normal);
						Search_Activity.favorite_mydb.getWritableDatabase().delete("favorite_list", "num" + "=" +num, null);
						if(Search_Activity.adapter != null){
							Search_Activity.adapter.notifyDataSetChanged();
						}
			...
			Search_Activity.favorite_mydb.close();
			if(cursor != null){
				cursor.close();	
			}
		}
