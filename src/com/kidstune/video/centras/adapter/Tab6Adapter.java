...
public class Tab6Adapter extends BaseAdapter{
	...
	public Tab6Adapter(Context context, ArrayList<Main_Data> list, ListView listview_main) {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		try{
			...
			cursor = Tab6_Activity.favorite_mydb.getReadableDatabase().rawQuery(
			...
			bt_favorite.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(num.equals("empty")){
						...
						Tab6_Activity.favorite_mydb.getWritableDatabase().insert("favorite_list", null, cv);
						...
						bt_favorite.setImageResource(R.drawable.bt_favorite_normal);
						Tab6_Activity.favorite_mydb.getWritableDatabase().delete("favorite_list", "num" + "=" +num, null);
						if(Tab6_Activity.adapter != null){
							Tab6_Activity.adapter.notifyDataSetChanged();
						}
			...
			Tab6_Activity.favorite_mydb.close();
			if(cursor != null){
				cursor.close();	
			}
		}
