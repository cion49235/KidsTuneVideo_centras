...
public class Tab4Adapter extends BaseAdapter{
	...
	public Tab4Adapter(Context context, ArrayList<Main_Data> list, ListView listview_main) {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		try{
			...
			cursor = Tab4_Activity.favorite_mydb.getReadableDatabase().rawQuery(
			...
			bt_favorite.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(num.equals("empty")){
						...
						Tab4_Activity.favorite_mydb.getWritableDatabase().insert("favorite_list", null, cv);
						...
						bt_favorite.setImageResource(R.drawable.bt_favorite_normal);
						Tab4_Activity.favorite_mydb.getWritableDatabase().delete("favorite_list", "num" + "=" +num, null);
						if(Tab4_Activity.adapter != null){
							Tab4_Activity.adapter.notifyDataSetChanged();
						}
			...
			Tab4_Activity.favorite_mydb.close();
			if(cursor != null){
				cursor.close();	
			}
		}
